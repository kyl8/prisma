...
function ClientDetailTabs({ company, go }: { company: WorkspaceCompany; go: (v: View) => void }) {
  ...
  return <>
    ...
    {tab === "activity" && <Card title={`Atividade de ${company.name}`} className="ws-card--wide"><RealActivityList items={company.activity} go={go} /></Card>}
  </>;
}
