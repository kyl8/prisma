...
Logcomex usa LOGCOMEX_API_URL, LOGCOMEX_API_KEY, LOGCOMEX_AGENT_ID e LOGCOMEX_PROMPT_ID para análise documental. O chat aceita somente IDs dedicados em LOGCOMEX_ASSISTANT_AGENT_ID e LOGCOMEX_ASSISTANT_PROMPT_ID. Nunca exponha essas variáveis no frontend.
